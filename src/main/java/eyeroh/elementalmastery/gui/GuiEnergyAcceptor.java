...
public class GuiEnergyAcceptor {
    ...
    public GuiEnergyAcceptor(TileEnergyAcceptor tileEntity, int width, int height, ResourceLocation background, int energyX, int energyY, int energySpace, int energyTextureX, int energyTextureY, int[] energyTypes) {
        //super(container);
        this.width = width;
        this.height = height;
