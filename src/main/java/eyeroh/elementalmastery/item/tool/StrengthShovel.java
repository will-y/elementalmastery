...
public class StrengthShovel extends ItemSpade{

	public StrengthShovel(String name) {
	...
	public boolean onBlockDestroyed(ItemStack stack, World world, IBlockState state, BlockPos pos, EntityLivingBase entityLiving) {
        if (!world.isRemote && (double)state.getBlockHardness(world, pos) != 0.0D) {
            ...
            for(int i = 0; i < 8; i++) {
            	...
            	if(material == Material.GROUND || material == Material.SNOW || material == Material.CRAFTED_SNOW || material == Material.GRASS || material == Material.SAND) {
